# source https://developers.google.com/gmail/api/auth/web-server
import logging
...
def path(file_name):
    '''
    Return the full path ro the data document in this project
    :param file_name: str - file neme iwth exstention (e.g. *.txt)
    :return: str

    Excemple:
    >>> path("file_name.txt")
    '/home/fenix/Documents/Programming/Lab_works_Python/lb_16/FIlm_map/module/../docs/file_name.txt'
    '''
...
#     }
#   }
CLIENTSECRETS_LOCATION = path("credentials.json")
...
def store_credentials(user_id, credentials):
    ...
    This function stores the provided OAuth 2.0 credentials using the
    user ID as key.
    ...
    """
    # TODO: Implement this function to work with your database.
    #       To retrieve a Json representation of the credentials instance,
    #       call the credentials.to_json() method.
    raise NotImplementedError()
...
def get_credentials(authorization_code, state):
    ...
    NoRefreshTokenException with the authorization URL to redirect the
    user to.
