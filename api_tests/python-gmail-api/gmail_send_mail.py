...
# -------------------------------------------------------------------------
# This is the name of the secret file you download from
#               https://console.developers.google.com/iam-admin/projects
# Give it a name that is unique to this project
CLIENT_SECRET_FILE = 'client_secret.json'
# This is the file that will be created in ~/.credentials holding your
# credentials. It will be created automatically
# the first time you authenticate and will mean you don't have to
# re-authenticate each time you connect to the API.
# Give it a name that is unique to this project
CREDENTIAL_FILE = 'The_Cup_bot.json'

APPLICATION_NAME = 'My_Cup'
# Set to True if you want to authenticate manually by visiting a given URL
# and supplying the returned code
# instead of being redirected to a browser. Useful if you're working on a
...
class Gmail():
    ...
    def send_mail(self, recipient_address, subject, body):
        ...
        try:
            message = self.__create_message(sender_address, recipient_address,
                                            subject, body)
...
to_address = "yurijpasichnyk11@gmail.com"
# subject = input("enter subject: ")
subject = "yurijpasichnyk11@gmail.com"
